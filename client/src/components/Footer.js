...
const Footer = () => {
    return (
        <div className='w-full '>
            ...
            <div className='h-[103px] w-full bg-main flex items-center justify-center'>
                <div className='w-main flex items-center justify-between'>
                    ...
                    <div className='flex-1 flex items-center'>
                        <input
                            className='p-4 pr-0 rounded-l-full w-full w-full bg-[#F04646] outline-none text-gray-100 placeholder:text-sm text-gray-100 
            ...
            <div className='h-[407x] w-full bg-gray-900 flex items-center justify-center text-white text-[13px]'>
                <div className='w-main flex'>
                    <div className='flex-2 flex flex-col gap-2 mt-10'>
